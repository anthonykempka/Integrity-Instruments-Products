...
//
// Description:
//  Tests the 485-25A data converter with a converter on both
...
int main (int argc, char *argv[])
{
    ...
    printf ("485-25A Testing Program\n");
    printf ("--------------------------------------------\n");
    printf ("%s\n", Copyright);
    printf ("%s\n", Address1);
    printf ("%s\n", Address2);
    ...
    InitializeCom (&ComPort1, COM1, BAUD_RATE_DIVISOR_115200, Lcr);
    InitializeCom (&ComPort2, COM2, BAUD_RATE_DIVISOR_115200, Lcr);
