...
// ASI DataMyte copyright notification
UCHAR Copyright[]="Copyright © 2007 ASI DataMyte, Inc. All rights reserved.";
...
--*/
{
    ...
    DbgPrint("Integrity Instruments, Inc. USBM400 driver WDM Version\n");
    DbgPrint("Built %s %s\n", __DATE__, __TIME__);
