========================================================================
		ActiveX Control DLL : INTEGRITYIO
========================================================================

ControlWizard has created this project for your INTEGRITYIO ActiveX Control
...
that make up your INTEGRITYIO ActiveX Control DLL.
...
IntegrityIOCtl.h
	This file contains the declaration of the CIntegrityIOCtrl C++ class.

IntegrityIOCtl.cpp
	This file contains the implementation of the CIntegrityIOCtrl C++ class.

IntegrityIOPpg.h
	This file contains the declaration of the CIntegrityIOPropPage C++ class.

IntegrityIOPpg.cpp
	This file contains the implementation of the CIntegrityIOPropPage C++ class.

IntegrityIOCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CIntegrityIOCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file IntegrityIO.rc.
