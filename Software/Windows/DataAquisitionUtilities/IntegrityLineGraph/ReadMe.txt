========================================================================
    ACTIVEX CONTROL DLL : IntegrityLineGraph Project Overview
========================================================================

ControlWizard has created this project for your IntegrityLineGraph ActiveX Control
...
that make up your IntegrityLineGraph ActiveX Control DLL.

IntegrityLineGraph.vcproj
...
IntegrityLineGraph.def
    This file contains information about the ActiveX Control DLL that
    must be provided to run with Microsoft Windows.

IntegrityLineGraph.idl
    This file contains the Object Description Language source code for the
    type library of your control.

IntegrityLineGraph.ico
    This file contains an icon that will appear in the About box.  This icon
    is included by the main resource file IntegrityLineGraph.rc.

/////////////////////////////////////////////////////////////////////////////
CIntegrityLineGraphCtrl control:

IntegrityLineGraphCtrl.h
    This file contains the declaration of the CIntegrityLineGraphCtrl C++ class.

IntegrityLineGraphCtrl.cpp
    This file contains the implementation of the CIntegrityLineGraphCtrl C++ class.

IntegrityLineGraphPropPage.h
    This file contains the declaration of the CIntegrityLineGraphPropPage C++ class.

IntegrityLineGraphPropPage.cpp
    This file contains the implementation of the CIntegrityLineGraphPropPage C++ class.

CIntegrityLineGraphCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CIntegrityLineGraphCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file IntegrityLineGraph.rc.
...
stdafx.h, stdafx.cpp
    ...
    named IntegrityLineGraph.pch and a precompiled types (PCT) file named stdafx.obj.
