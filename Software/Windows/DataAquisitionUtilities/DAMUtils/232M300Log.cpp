// 232M300Log.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(C232M300Log, CDialog)
C232M300Log::C232M300Log(CWnd* pParent /*=NULL*/)
	: CDialog(C232M300Log::IDD, pParent)
...
C232M300Log::~C232M300Log()
{
	HaltThread();
}

void C232M300Log::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(C232M300Log, CDialog)
...
// C232M300Log message handlers

void C232M300Log::OnBnClickedBtnbrowsem300log()
{
	/*
...
void C232M300Log::OnBnClickedOk()
{
	HaltThread();
...
void C232M300Log::OnBnClickedCancel()
{
	HaltThread();
	m_cIICtrl->SetbPortOpen(FALSE);
	OnCancel();
...
void C232M300Log::OnBnClickedBtnM300logstart()
{
	UpdateData();
	...
	if(channelCount)
	{
		...
		m_cIILG.put_ulElementColor(0,C232M300Log::GraphColors::ch0);
		m_cIILG.put_ulElementColor(1,C232M300Log::GraphColors::ch1);
		m_cIILG.put_ulElementColor(2,C232M300Log::GraphColors::ch2);
		m_cIILG.put_ulElementColor(3,C232M300Log::GraphColors::ch3);
		m_cIILG.put_ulElementColor(4,C232M300Log::GraphColors::ch4);
		m_cIILG.put_ulElementColor(5,C232M300Log::GraphColors::ch5);
		m_cIILG.put_ulElementColor(6,C232M300Log::GraphColors::ch6);
		m_cIILG.put_ulElementColor(7,C232M300Log::GraphColors::ch7);
	}
...
void C232M300Log::OnBnClickedBtnM300logstop()
{
	HaltThread();
...
void C232M300Log::SetChCheckStates(void)
{
 ...
 */
void C232M300Log::OnBnClickedRbdiffadcoff()
{
	m_nSampleType0 = 0;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcpos()
{
	m_nSampleType0 = 1;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcneg()
{
	m_nSampleType0 = 2;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcoff2()
{
	m_nSampleType2 = 0;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcpos2()
{
	m_nSampleType2 = 1;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcneg2()
{
	m_nSampleType2 = 2;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcoff3()
{
	m_nSampleType4 = 0;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcpos3()
{
	m_nSampleType4 = 1;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcneg3()
{
	m_nSampleType4 = 2;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcoff4()
{
	m_nSampleType6 = 0;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcpos4()
{
	m_nSampleType6 = 1;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::OnBnClickedRbdiffadcneg4()
{
	m_nSampleType6 = 2;
	UpdateData();
	SetChCheckStates();
...
void C232M300Log::HaltThread(void)
{
...
UINT C232M300Log::LogThreadProc(LPVOID pParam)
{
	C232M300Log *pThis = (C232M300Log*)pParam;
	CString str;
	CString strTemp;
...
void C232M300Log::OnEnChangeEbm300graphmin()
{
	UpdateData();
...
void C232M300Log::OnEnChangeEbm300graphmax()
{
	UpdateData();
